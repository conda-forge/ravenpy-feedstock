...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ravenpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12687&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ravenpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ravenpy` can be installed with:

```
conda install ravenpy
```

It is possible to list all of the versions of `ravenpy` available on your platform with:
